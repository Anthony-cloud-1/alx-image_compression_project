...
const displayResults = () => {
    ...
    // Show the download all button if there are results
    if (document.querySelector('.results__list').children.length > 1) {
...
const downloadAllFiles = () => {
    const links = document.querySelectorAll('.results__download a');
    links.forEach(link => {
